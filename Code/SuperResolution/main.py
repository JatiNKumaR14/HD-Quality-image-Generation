...
flags.DEFINE_integer("label_size", 256, "The size of label")
...
flags.DEFINE_integer("stride", 1, "the size of stride")
...
flags.DEFINE_integer("batch_size", 5, "the size of batch")
